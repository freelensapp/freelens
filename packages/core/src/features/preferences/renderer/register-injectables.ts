...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(PreferencesRouteComponent); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(preferencesRouteComponentInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { registerClosePreferencesInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerComplianceForLegacyExtensionApiInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerPreferenceItemsInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerPreferenceNavigationInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
}
