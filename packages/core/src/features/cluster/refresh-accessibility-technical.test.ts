...
} as PartialDeep<V1NamespaceList> as Awaited<ReturnType<CoreV1Api["listNamespace"]>>;
...
} as PartialDeep<V1SelfSubjectRulesReview> as CreateSelfSubjectRulesReviewRes;
