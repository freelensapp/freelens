...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(clusterOverviewMetricsInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(clusterOverviewRouteComponentInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(clusterOverviewSidebarItemInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(clusterStoreInjectable); } catch (e) { /* Ignore duplicate registration */ }
