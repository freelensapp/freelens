...
export interface TLSRouteDetailsProps extends KubeObjectDetailsProps<TLSRoute> {}

const NonInjectedTLSRouteDetails = observer((props: TLSRouteDetailsProps) => {
...
export const TLSRouteDetails = withInjectables<{}, TLSRouteDetailsProps>(NonInjectedTLSRouteDetails, {
