...
export interface UDPRouteDetailsProps extends KubeObjectDetailsProps<UDPRoute> {}

const NonInjectedUDPRouteDetails = observer((props: UDPRouteDetailsProps) => {
...
export const UDPRouteDetails = withInjectables<{}, UDPRouteDetailsProps>(NonInjectedUDPRouteDetails, {
