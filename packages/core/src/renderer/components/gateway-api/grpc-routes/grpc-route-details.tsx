...
const NonInjectedGRPCRouteDetails = observer((props: GRPCRouteDetailsProps) => {
...
export const GRPCRouteDetails = withInjectables<{}, GRPCRouteDetailsProps>(NonInjectedGRPCRouteDetails, {
