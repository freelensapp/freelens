...
import { ContainerScalingMode, ControlledValues, ResourceName, UpdateMode, VerticalPodAutoscaler } from "@freelens/kube-object";
import type { PodUpdatePolicy, PodResourcePolicy, VerticalPodAutoscalerStatus } from "@freelens/kube-object";
