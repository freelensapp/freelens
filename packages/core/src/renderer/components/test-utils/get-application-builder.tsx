...
import { applicationFeatureForElectronMain, testUtils as applicationForElectronTestUtils } from "@freelens/application-for-electron-main";
...
import { getMessageBridgeFake } from "@freelens/messaging-fake-bridge";
