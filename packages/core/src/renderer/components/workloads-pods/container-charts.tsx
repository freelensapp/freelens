...
const NonInjectedContainerCharts = observer(({ activeTheme, selectedMetricsTimeRange }: Dependencies & ContainerChartsProps) => {
  ...
  return <BarChart name={`metrics-${tab}`} options={metricTabOptions[tab]} data={{ datasets: datasets[tab] }} minTime={minTime} maxTime={maxTime} />;
});
