...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(bundledKubectlBinaryPathInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(bundledKubectlInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(createKubectlInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlApplyAllChannelHandlerInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlApplyAllInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlBinaryNameInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlDeleteAllChannelHandlerInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlDeleteAllInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlDownloadingNormalizedArchInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(kubectlVersionMapInjectable); } catch (e) { /* Ignore duplicate registration */ }
}
