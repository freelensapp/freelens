...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(getHelmReleaseResourcesInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { registerCallForHelmManifestInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerCallForKubeResourcesByManifestInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
}
