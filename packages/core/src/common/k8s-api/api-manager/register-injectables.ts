...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(apiManagerInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(autoRegistrationEmitterInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(createCustomResourceStoreInjectable); } catch (e) { /* Ignore duplicate registration */ }
}
