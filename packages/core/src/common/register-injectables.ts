...
export function registerInjectables(di: DiContainerForInjection): void {
  try { di.register(clusterFramesInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { di.register(logErrorInjectable); } catch (e) { /* Ignore duplicate registration */ }
  try { registerAppEventBusInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  ...
  try { registerCatalogEntitiesInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  ...
  try { registerDirectoryForLensLocalStorageInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerFetchInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerFrontEndRoutingInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerFsInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerGetConfigurationFileModelInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  ...
  try { registerK8sApiInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerKubeHelpersInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerOsInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
  try { registerPathInjectables(di); } catch (e) { /* Ignore duplicate registration */ }
